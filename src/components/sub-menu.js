    ...
    <div class="side-menu-wrapper">
      ...
      <div class="menu-item">
        <ul>
          ...
          <li>
            ...
            <ul class="sub-menu">
              ...
              <li>
                ...
                >
                  <span class="round-arrow" /> Technicalspecifications - FAQs
                </a>
              </li>
              <li>
                <a
          ...
          <li>
            {" "}
            <Link to={`/page-1`} className="menu_header selected">
              <a class="" id="rummy-wiki">
                <span class="white-arrow" />
                <span class="black-arrow" /> Rummy Wiki
                <span class="top-arrow" />
              </a>
            </Link>
              ...
              <li>
                <Link to={`/page-2`}>
                  <a id="rummy-wiki/online-vs-offline-rummy">
                    <span class="round-arrow" /> Online vs Off rummy
                  </a>
                </Link>
              </li>
              <li>
                <Link to={`/page-3`}>
                  <a id="rummy-wiki/history-of-rummy">
                    <span class="round-arrow" /> History of rummy
                  </a>
                </Link>
              </li>
            </ul>
